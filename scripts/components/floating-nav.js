import { reducedMotionQuery } from "../core/constants.js?v=57";
import { onScrollSettle, onWheelActivity, smoothScrollToSection } from "../core/scroll.js?v=57";
import { getCurrentSection, isSectionInViewport } from "../core/sections.js?v=57";
...
export let pendingFloatingNavSectionId = "";
...
export function wakeFloatingNav() {
    if (!sectionFloatingNav || !sectionFloatingNav.classList.contains("is-visible")) {
        return;
    }
...
export function updateFloatingNavState() {
    if (!sectionFloatingNav) {
        return;
    }
