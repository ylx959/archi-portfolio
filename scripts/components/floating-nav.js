...
import { onScrollSettle, onWheelActivity, smoothScrollToSection } from "../core/scroll.js?v=47";
import { getCurrentSection, isSectionInViewport } from "../core/sections.js?v=47";
