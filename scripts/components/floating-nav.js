...
import { onScrollSettle, onWheelActivity, smoothScrollToSection } from "../core/scroll.js?v=70";
import { getCurrentSection, isSectionInViewport } from "../core/sections.js?v=70";
import { isEntered } from "../core/state.js?v=70";
