...
// The "&" does not arrive with the rest of the headline. Architecture and
// Design grow in by weight (hero-headline.js); the ampersand arrives from off
// the right edge of the window in a series of hops along the baseline, crouches
// to gather itself, and clears "Design" on the last one to reach the slot
// between the two words.
//
// It talks to the hero the same way hero-headline.js does — the hero asks for
// the entrance with `portfolio:hero-drop`, this answers `portfolio:hero-dropped`
